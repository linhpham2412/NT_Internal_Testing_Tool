...
public class QuestionDesigner {
    ...
    Button checkTempChange = new Button("Preview Question");
    ...
    public VBox generateElements() {
        ...
        leftCommandPane.setPrefWidth(screenWidth / 2.4);
        Label commandText = new Label("Ctrl-1[Enter] | Ctrl-2[Insert Image] | Ctrl-3[Add/Edit Table]");
        commandText.setFont(toolFont);
        leftCommandPane.getChildren().add(commandText);

        HBox rightCommandPane = new HBox();
        rightCommandPane.setPrefWidth(screenWidth / 1.7);
        ...
        checkTempChange.setPrefSize(70,50);
        checkTempChange.setWrapText(true);
        checkTempChange.setStyle(cssBlueColorBGValue);
        prevQuestion.setFont(toolFont);
        nextQuestion.setFont(toolFont);
        firstQuestion.setFont(toolFont);
        lastQuestion.setFont(toolFont);
        addQuestion.setPrefSize(70,50);
        addQuestion.setWrapText(true);
        addQuestion.setStyle(cssBlueColorBGValue);
        deleteQuestion.setPrefSize(70,50);
        deleteQuestion.setWrapText(true);
        deleteQuestion.setStyle(cssRedColorBGValue);
        HBox.setMargin(addQuestion, new Insets(0, 0, 0, 10));
        HBox.setMargin(deleteQuestion, new Insets(0, 0, 0, 10));
        ...
        rightCommandPane.getChildren().add(deleteQuestion);
        ...
        applyGroupButton.setPrefSize(70,50);
        applyGroupButton.setStyle(cssBlueColorBGValue);
        applyGroupButton.setWrapText(true);
